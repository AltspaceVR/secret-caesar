...
// create the card faces
    let frontGeo = new THREE.PlaneGeometry(0.715, 1)
...
export {
  Card, Types, BlankCard, CreditsCard, LiberalPolicyCard, FascistPolicyCard, LiberalRoleCard, FascistRoleCard, HitlerRoleCard, LiberalPartyCard, FascistPartyCard, JaCard, NeinCard
}
